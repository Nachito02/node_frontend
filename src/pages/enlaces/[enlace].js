      ...
      {tienePassword ? (
        <>
          <p className="text-center">
            Este enlace esta protegido con password, colocalo a continuacion
          </p>
        ...
        <>
          ...
          <div className="flex items-center justify-center mt-10">
            <a
              ...
              className="bg-red-500 text-center px-1 py-3 rounded uppercase font-bold text-white cursor-pointer"
            >
              Aqui
            </a>
          </div>{" "}
